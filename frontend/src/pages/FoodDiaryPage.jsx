  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        // Kita pastikan menyertakan total kalori dasar dari state
        total_calories: formData.total_calories ? formData.total_calories : 0
      };
      ...
      console.log(error);
      alert("Gagal menyimpan food diary");
    }
  };
